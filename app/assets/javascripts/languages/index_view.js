$(document).ready(function(){
  if(this_page("LanguagesController", "index")){
    ...
    player1.play(JSON.parse(hello_world));  
    player2.play(JSON.parse(happy_coding))
